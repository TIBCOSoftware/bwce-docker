...
* **Provision suppprted JDBC drivers**:
     ...
     * Copy the appropriate driver OSGi bundle from `<TIBCO_HOME>/bwce/2.x/config/drivers/shells/<driverspecific runtime>/runtime/plugins/` to  `<Your-local-docker-repo>/resources/addons/jars` folder. 
